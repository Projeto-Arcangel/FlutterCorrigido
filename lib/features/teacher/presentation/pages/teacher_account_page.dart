...
//   #4  Consistência: tipografia Nunito, paleta verde e padrão de tile
//       idênticos ao teacher_settings_page.dart.
...
class TeacherAccountPage extends ConsumerStatefulWidget {
  const TeacherAccountPage({super.key});

  @override
  ConsumerState<TeacherAccountPage> createState() => _TeacherAccountPageState();
}

class _TeacherAccountPageState extends ConsumerState<TeacherAccountPage>
  ...
  void _snack(String msg, {bool error = false}) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
      ...
      backgroundColor: error ? _TC.danger : _TC.accent,
  ...
  Widget build(BuildContext context) {
    ...
    final displayName = user?.displayName ??
        (email.isNotEmpty ? email.split('@').first : 'Professor');
    ...
    if (_deletingAccount) {
      return Scaffold(
        ...
        body: const Center(
          child: CircularProgressIndicator(color: _TC.accent),
        ),
      );
    }
  ...
  PreferredSizeWidget _buildAppBar(bool isDark) => AppBar(
        ...
        leading: IconButton(
          tooltip: 'Voltar',
          icon: Icon(Icons.chevron_left, color: _TC.textPrimary(isDark), size: 28),
  ...
  Widget build(BuildContext context) => Padding(
        ...
        child: Text(
          ...
          style: GoogleFonts.nunito(
            ...
            color: danger
                ? _TC.danger.withValues(alpha: 0.85)
                : _TC.textMuted,
            letterSpacing: 2.2,
          ),
        ),
...
class _TileDivider extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Divider(color: _TC.divider(isDark), height: 1),
    );
  }
}
  ...
  Widget build(BuildContext context) {
    ...
    return Material(
      ...
      child: InkWell(
        ...
        splashColor: readOnly ? Colors.transparent : _TC.accentSubtle,
        highlightColor: readOnly
            ? Colors.transparent
            : _TC.accentSubtle.withValues(alpha: 0.4),
        child: Padding(
          ...
          child: Row(
            children: [
              Container(
                ...
                child: Icon(icon, color: _TC.accent, size: 20),
              ),
              const SizedBox(width: 16),
              ...
              if (badgeText != null)
                ...
                Icon(
                  Icons.lock_rounded,
                  color: _TC.textMuted.withValues(alpha: 0.4),
                  size: 16,
                ),
            ],
          ),
  ...
  Widget build(BuildContext context) {
    ...
    return Material(
      ...
      child: InkWell(
        onTap: onTap,
        borderRadius: BorderRadius.circular(16),
        splashColor: _TC.dangerSubtle,
        highlightColor: _TC.dangerSubtle.withValues(alpha: 0.4),
        child: Container(
          padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 18),
          decoration: BoxDecoration(
            border: Border.all(color: _TC.danger.withValues(alpha: 0.3)),
            borderRadius: BorderRadius.circular(16),
          ),
          child: Row(
            children: [
              Container(
                ...
                height: 40,
                decoration: BoxDecoration(
                  color: _TC.dangerSubtle,
                  borderRadius: BorderRadius.circular(11),
                ),
                child: Icon(icon, color: _TC.danger, size: 20),
              ),
              const SizedBox(width: 16),
              Expanded(
                child: Column(
              ...
              Icon(
                Icons.chevron_right_rounded,
                color: _TC.danger.withValues(alpha: 0.6),
                size: 22,
              ),
            ],
          ),
...
class _DarkTextField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return TextFormField(
      ...
      validator: validator,
      autofocus: autofocus,
      style: GoogleFonts.nunito(fontSize: 15, color: _TC.textPrimary(isDark)),
      decoration: InputDecoration(
        labelText: label,
        labelStyle: GoogleFonts.nunito(fontSize: 14, color: _TC.textMuted),
        suffixIcon: suffixIcon,
        filled: true,
        fillColor: _TC.fieldFill(isDark),
        contentPadding:
        ...
        enabledBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(12),
          borderSide: BorderSide(color: _TC.cardBorder(isDark)),
        ),
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(12),
          borderSide: const BorderSide(color: _TC.accent, width: 2),
        ),
        errorBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(12),
          borderSide: const BorderSide(color: _TC.danger),
        ),
        focusedErrorBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(12),
          borderSide: const BorderSide(color: _TC.danger, width: 2),
        ),
        errorStyle: GoogleFonts.nunito(fontSize: 12, color: _TC.danger),
      ),
    );
  }
}
  ...
  return SizedBox(
    ...
    child: FilledButton(
      ...
      style: FilledButton.styleFrom(
        backgroundColor: backgroundColor ?? _TC.accent,
        foregroundColor: Colors.white,
        disabledBackgroundColor:
            (backgroundColor ?? _TC.accent).withValues(alpha: 0.5),
        ...
        SizedBox(
          ...
          child: OutlinedButton(
            ...
            style: OutlinedButton.styleFrom(
              ...
              side: BorderSide(color: _TC.divider(isDark)),
