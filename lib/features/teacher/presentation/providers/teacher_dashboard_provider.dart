...
final teacherDashboardProvider =
  ...
  // 1. Busca a primeira sala do professor
  final classroomsResult = await ref
  ...
  final phasesResult = await ref
      .watch(classroomRepositoryProvider)
      .getClassroomPhases(classroom.id);
  ...
  final resultsResult =
      await ref.watch(classroomRepositoryProvider).getResults(classroom.id);
